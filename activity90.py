...
FONT_SIZE=72
pygame.init()
backgrond_image=pygame.transform.scale(pygame.image.load("bg.jpeg")),
...
class Sprite(pygame.sprite.Sprite):
    def __init__(self,color,height,width):
        ...
        self.image.fill(pygame.Color("lemon yellow"))
...
while running:
    ...
    if not won:
        ...
        if sprite1.rect.collidedict(sprite2):
            all_sprites.remove(sprite2)
            won=True
    screen.blit(backgrond_image,(0,0))
